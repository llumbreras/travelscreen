...
Video.create(title: "About Time" , description: "Travel in time and change what happens", small_cover_url: "/tmp/about_time_small.png", large_cover_url: "/tmp/about_time_large.png" )
Video.create(title: "Up", description: "Sets out to fulfill lifelong dream", small_cover_url: "/tmp/up_small.png", large_cover_url: "/tmp/up_large.png" )
Video.create(title: "Rio", description: "Takes off on an adventure", small_cover_url: "/tmp/rio_small.png", large_cover_url: "/tmp/rio_large.png")
Video.create(title: "Midnight in Paris", description: "Going back to the 1920s every day at midnight", small_cover_url: "/tmp/midnight_in_paris_small.png", large_cover_url: "/tmp/midnight_in_paris_large.png")
